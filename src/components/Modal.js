            ...
            <div className="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
                ...
                <div className="">
                    ...
                    <div className="p-3  mt-2 text-center space-x-4 md:block">
                        ...
                        <button className="mb-2 md:mb-0 bg-green-500 border border-green-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-red-600">Accept</button>
                    </div>
                </div>
            </div>
        </div>
